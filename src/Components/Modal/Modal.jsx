...
const MyModal = (props) => {
  ...
  const submitUser = () => {
    fetch("https://60965395116f3f00174b2f00.mockapi.io/users", {
      ...
      body: JSON.stringify({
        ...
        email: userEmail,
        image:
          "https://primacgurus.com.au/wp-content/uploads/2021/01/No-Profile-image.jpg",
      }),
    })
      .then((res) => res.json())
      .then(() => {
  ...
  const body = (
    <div
      style={modalStyle}
      className={`${classes.paper} modal-${theme} modal-view`}
    >
      <h2
        id="simple-modal-title"
        className="is-size-4 has-text-centered mb-3 main-text"
      >
        Add New User
      </h2>
      <p
